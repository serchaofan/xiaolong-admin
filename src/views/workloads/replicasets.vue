    ...
    <el-row :gutter="20">
      <el-col :span="24">
        <el-card>
          ...
          <el-table
            stripe
            :data="replicasetsList.filter(data => !search || data.name.toLowerCase().includes(search.toLowerCase()))"
            width="100%"
...
<script>
    import {getReplicasetsList} from "@/api/k8s";
